    ...
    template: `
        <div class="accordion" id="accordion" role="tablist">
            ...
            <div class="card-header" role="tab">
                <h6><a href="#card" data-toggle="collapse" class="" aria-expanded="true"><i class="icon-columns"></i>Pay with
                    Credit
                    Card
                </a></h6>
            </div>
            <div class="collapse show" id="card" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                <p>Aceptamos las siguientes tarjetas de crédito:&nbsp;<img class="d-inline-block align-middle" src=" http://themes.rokaux.com/unishop/v3.0/template-1/img/credit-cards.png
                            " style="width: 120px;" alt="Cerdit Cards"></p>
        ...
        thru">••/••</div>
                ...
                <form class="interactive-credit-card row" [formGroup]="forma" name="forma" novalidate>
                    <div class="form-group col-sm-6">
                    <input class="form-control form-control-sm" type="text" name="number" placeholder="Card Number" required=""
                        formControlName="tarjetaNumero">
                    </div>
                    <div class="form-group col-sm-6">
                    <input class="form-control form-control-sm" type="text" name="name" placeholder="Full Name" required=""
                        formControlName="nombreCompleto">
                    </div>
                    <div class="form-group col-sm-3">
                    <input class="form-control form-control-sm" type="text" name="expiry" placeholder="MM/YY" required=""
                        formControlName="vencimiento">
                    </div>
                    <div class="form-group col-sm-3">
                    <input class="form-control form-control-sm" type="text" name="cvc" placeholder="CVC" required=""
            ...
            <div class="card">
            <div class="card-header" role="tab">
                <h6><a class="collapsed" href="#paypal" data-toggle="collapse"><i class="socicon-paypal"></i>Pay with PayPal</a>
                </h6>
            </div>
            <div class="collapse" id="paypal" data-parent="#accordion" role="tabpanel">
                <div class="card-body">
                <p>PayPal - the safer, easier way to pay</p>
                <form class="row" method="post" [formGroup]="forma" name="forma" novalidate>
                    <div class="col-sm-6">
                    <div class="form-group">
                        <input class="form-control form-control-sm" type="email" placeholder="E-mail" required="" formControlName="email"
                    >
                    </div>
                    </div>
                    <div class="col-sm-6">
                    <div class="form-group">
                        <input class="form-control form-control-sm" type="password" placeholder="Password" required="" formControlName="pass"
                    >
                    </div>
                    </div>
                    <div class="col-12">
                    <div class="d-flex flex-wrap justify-content-between align-items-center"><a class="navi-link"
                        href="#">Forgot
                        password?
                        </a>
            ...
            <div class="card">
            <div class="card-header" role="tab">
                <h6><a class="collapsed" href="#points" data-toggle="collapse"><i class="icon-medal"></i>Redeem Reward Points</a>
                </h6>
            </div>
